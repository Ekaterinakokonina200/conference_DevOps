...
* [Схема данных](docs/data-schema.md)
* [HTTP API](docs/api.md)
* [Правила внесения изменений](docs/contribution-rules.md)
* [Ручное тестирование](docs/manual-testing.md)
* [Разрешение merge conflict](docs/merge-conflict.md)
